...
function Apie() {
  return (
    <>
      ...
      <div className="apie">
        <p>
          I am a digital artist who loves to create animated charaters and illustrations. I also have made frame-by-frame and spine animations as a hobby<br/><br/>
          I am originally from Lithuania but have lived in other countries, which has given me a lot of experience 
          ...
          In addition, while volunteering in highschool student council, I had the opportunity to learn how to create advertising visualizations. 
          After that I also attended a 2 year filmschool course in "Skalvijos Movie Academy" which enlightened me on the topic of film and visual storytelling.
